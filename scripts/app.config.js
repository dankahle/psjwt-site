angular.module('psJwtApp').config(function ($urlRouterProvider, $stateProvider, $httpProvider, $authProvider, API_URL) {
	...
	.state('main', {
		url: '/',
		templateUrl: '/psjwt-site/views/main.html'
	})

	.state('register', {
		url: '/register',
		templateUrl: '/psjwt-site/views/register.html',
		controller: 'RegisterCtrl'
	})

	.state('login', {
		url: '/login',
		templateUrl: '/psjwt-site/views/login.html',
		controller: 'LoginCtrl'
	})

	.state('jobs', {
		url: '/jobs',
		templateUrl: '/psjwt-site/views/jobs.html',
		controller: 'JobsCtrl'
	})
